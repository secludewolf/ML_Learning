...
if __name__ == "__main__":
    ...
    # 马疝病数据集
    # 训练集合
    dataArr, labelArr = loadDataSet("../../../data/7.Ensemble_Method/horseColicTraining2.txt")
    weakClassArr, aggClassEst = adaBoostTrainDS(dataArr, labelArr, 40)
    print(weakClassArr, '\n-----\n', aggClassEst.T)
    # 计算ROC下面的AUC的面积大小
    plotROC(aggClassEst.T, labelArr)
    # 测试集合
    dataArrTest, labelArrTest = loadDataSet("../../../data/7.Ensemble_Method/horseColicTest2.txt")
